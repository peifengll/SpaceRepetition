...
func newDeck(db *gorm.DB, opts ...gen.DOOption) deck {
	...
	_deck.ID = field.NewInt64(tableName, "id")
	...
	_deck.Cardnum = field.NewInt64(tableName, "cardnum")
	_deck.Learnnumber = field.NewInt64(tableName, "learnnumber")
	_deck.Introduction = field.NewString(tableName, "introduction")
	_deck.Floderid = field.NewInt64(tableName, "floderid")
	_deck.UserID = field.NewString(tableName, "user_id")
...
func (d *deck) updateTableName(table string) *deck {
	...
	d.Cardnum = field.NewInt64(table, "cardnum")
	d.Learnnumber = field.NewInt64(table, "learnnumber")
	d.Introduction = field.NewString(table, "introduction")
	d.Floderid = field.NewInt64(table, "floderid")
...
func (d *deck) fillFieldMap() {
	...
	d.fieldMap["cardnum"] = d.Cardnum
	d.fieldMap["learnnumber"] = d.Learnnumber
	d.fieldMap["introduction"] = d.Introduction
	d.fieldMap["floderid"] = d.Floderid
