...
func newAdmin(db *gorm.DB, opts ...gen.DOOption) admin {
	...
	_admin.Privileges = field.NewInt64(tableName, "privileges")
...
type admin struct {
	...
	Name       field.String
	Phone      field.String
	Privileges field.Int64 // 0是终极权限  还可撤销别人的一级权限，但不能赋为0权限，可删除其他人的管理员账号 , 1级是完整权限 ，可更改2级为1级，2级是部分
...
func (a *admin) updateTableName(table string) *admin {
	...
	a.Privileges = field.NewInt64(table, "privileges")
